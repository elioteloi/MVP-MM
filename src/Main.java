...
//        // instantiate products
        ...
        Product product1 = new Product(1,"apple", "2323231", 20.00, 10.00, 100);
//
        Product product2 = new Product(2,"banana", "787863", 10.00, 5.00, 200);
////
...
//
//        System.out.println("Name: " + pdt1);
//
//        System.out.println("Name: " + pdt2.getName());
//
////        // edit product
//        productService.editProduct(9, pdt1.getName(), pdt1.getBarCode(), pdt1.getPrice(), pdt1.getAverageCost(), 50);
////
...
//        // instantiate sale
//        // create discount
        DiscountFidelity discountFidelity = new DiscountFidelity(corporateClient.getCategory(), 10);
////
////
